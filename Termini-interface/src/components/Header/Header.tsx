...
import logoSmallImg from "img//logo/logo.svg";
          ...
          <div className="App-header large">
            <div className="App-header-container-left">
              <Link className="App-header-link-main" to="/">
                <img src={logoImg} className="big" alt="Termini Logo" />
                <img src={logoSmallImg} className="small" alt="Termini Logo" />
              </Link>
      ...
      <AnimatePresence>
        {isDrawerVisible && (
          <motion.div
            ...
            className="App-header-links-container App-header-drawer relative"
            initial="hidden"
            animate="visible"
            exit="hidden"
