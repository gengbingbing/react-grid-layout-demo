    ...
    <Portal>
      ...
      <RemoveScroll enabled={isOpen}>
        <div
          ...
          ref={setCurtainRef}
          className={cx(
            "text-body-medium fixed left-0 right-0 z-[10000] flex flex-col rounded-t-4 border-x border-t border-[var(--color-border)]",
            className
          )}
          style={{
        ...
        >
          <div onPointerDown={handlePointerDown} onPointerMove={handlePointerMove} onPointerUp={handlePointerUp}>
            <div className="flex touch-none select-none items-stretch justify-between gap-4 px-14 pb-14 pt-14"
              ...
              <div className="text-body-large grow"
                   style={{
            ...
            {headerRef ? (
              <div className="px-14 last:*:mb-14" 
                   style={{ padding: "0 var(--spacing-6)" }}
                   ref={headerRef} />
            ) : headerContent ? (
              <div className="px-14 last:*:mb-14"
                   style={{ padding: "0 var(--spacing-6)" }}>{headerContent}</div>
            ) : null}
          ...
          >
            <div className={cx("flex grow flex-col", contentPadding ? "p-14" : "pr-5")}
                 style={{
                   padding: contentPadding ? "var(--spacing-6)" : "0 var(--spacing-2) 0 0"
                 }}>{children}</div>
          </div>
          {footerContent && (
            <>
