            ...
            >
              <div className="menu-item-group">
                <div className="menu-item-icon">
                  <SettingsIcon16 className="network-dropdown-icon" style={{ color: "var(--color-text-primary)" }} />
                </div>
  ...
  return (
    <div className="network-dropdown-items">
      <div className="network-dropdown-list">
        ...
        >
          <div className="menu-item-group">
            <SettingsIcon24 className="mr-16" style={{ marginRight: "var(--spacing-6)", color: "var(--color-text-primary)" }} />
