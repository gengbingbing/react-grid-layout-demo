...
import { bigintToNumber } from "utils/numbers";
...
export function formatNumberKM(input: any, digits: boolean = true): string {
  const num = Number(input);
  if (isNaN(num)) {
    return '0'
  }

  const floorFixed = (number: number, digits: number) => {
    const factor = Math.pow(10, digits);
    return (Math.floor(number * factor) / factor).toFixed(digits);
  };

  if (num < 1000) {
    return floorFixed(num, 2);
  } else if (num < 1000000) {
    return floorFixed(num / 1000, 2) + 'K';
  } else if (num < 1000000000) {
    return floorFixed(num / 1000000, 2) + 'M';
  } else if (num < 1000000000000) {
    return floorFixed(num / 1000000000, 2) + 'B';
  } else if (num < 1000000000000000) {
    return floorFixed(num / 1000000000000, 2) + 'T';
  } else if (num < 1000000000000000000) {
    return floorFixed(num / 1000000000000000, 2) + 'Q';
  } else if (num < 1000000000000000000000) {
    return floorFixed(num / 1000000000000000000, 2) + 'Qi';
  } else if (num < 1000000000000000000000000) {
    return floorFixed(num / 1000000000000000000000, 2) + 'S';
  } else if (num < 1000000000000000000000000000) {
    return floorFixed(num / 1000000000000000000000000, 2) + 'Sp';
  } else if (num < 1000000000000000000000000000000) {
    return floorFixed(num / 1000000000000000000000000000, 2) + 'O';
  } else {
    return floorFixed(num / 1000000000000000000000000000000, 2) + 'N'; // Nonillion
  }
}

export function formatNumberWithCommas(value: number | string, digits: number = 2, isKM: boolean = false) {
  if (!Number(value)) {
    return '0'
  }
  if (Number(value) < 0.01 && Number(value) > 0 && digits === 2) {
    return '<0.01'
  }
  if (isKM) {
    return formatNumberKM(value)
  }
