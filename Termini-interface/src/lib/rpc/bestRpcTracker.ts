/**
 * RPC节点追踪器，主要用于管理和优化区块链 RPC 节点的连接。
 * 
 */
...
const PROBE_SAMPLE_MARKET = {
  [MINATO_MAINNET]: "0xB7e69749E3d2EDd90ea59A4932EFEa2D41E245d7", // ETH/USD
  [MINATO_TESTNET]: "0xbf338a6C595f06B7Cfff2FA8c958d49201466374", // ETH/USD
};
...
function initTrackerState() {
  ...
  return SUPPORTED_CHAIN_IDS.reduce<RpcTrackerState>((acc, chainId) => {
    ...
    let currentSecondaryUrl: string = FALLBACK_PROVIDERS[chainId][0];
