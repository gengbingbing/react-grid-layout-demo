...
export declare namespace Multicall {
  ...
  export type ResultStruct = { success: boolean; data: BytesLike };

  export type ResultStructOutput = [success: boolean, data: string] & {
    success: boolean;
    data: string;
  };
}
...
export interface MulticallInterface extends Interface {
  getFunction(nameOrSignature: "aggregate" | "multicall"): FunctionFragment;
