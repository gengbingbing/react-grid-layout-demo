...
export interface RewardTrackerFeesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASIS_POINTS_DIVISOR"
      | "PRECISION"
      | "allCumulativeRewards"
      | "allowance"
      | "allowances"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "allCumulativeRewards",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "tokensPerIntervals",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace ClaimEvent {
  ...
  export type OutputTuple = [receiver: string, arg1: string[], arg2: bigint[]];
  export interface OutputObject {
    receiver: string;
    arg1: string[];
    arg2: bigint[];
...
export interface RewardTrackerFees extends BaseContract {
  connect(runner?: ContractRunner | null): RewardTrackerFees;
  waitForDeployment(): Promise<this>;

  interface: RewardTrackerFeesInterface;
  ...
  allCumulativeRewards: TypedContractMethod<
  ...
  tokensPerIntervals: TypedContractMethod<[], [[string[], bigint[]]], "view">;
  ...
  getFunction(
    nameOrSignature: "allCumulativeRewards"
  ...
  getFunction(
    nameOrSignature: "tokensPerIntervals"
