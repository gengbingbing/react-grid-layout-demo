...
export interface StableCoinPositionRouterInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "admin"
      | "callbackGasLimit"
...
export interface StableCoinPositionRouter extends BaseContract {
  connect(runner?: ContractRunner | null): StableCoinPositionRouter;
  waitForDeployment(): Promise<this>;

  interface: StableCoinPositionRouterInterface;
